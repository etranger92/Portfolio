...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.triggerMenuMobile = exports.animationOut = exports.scroll = void 0;
var scroll = function (e, t, n) {
    var o = window.innerHeight / n;
    null != e && (e.getBoundingClientRect().top < o && e.classList.add(t))
};
exports.scroll = scroll;
var animationOut = function (e, t, n) {
    return setTimeout(function () {
        e.classList.add(t)
    }, n)
};
exports.animationOut = animationOut;
...
exports.triggerMenuMobile = triggerMenuMobile;
var REGEX = {
    ...
    headerAnimations = {
        init: function () {
            headerAnimations.displayHeaderContainer(), headerAnimations.displayIcon(), headerAnimations.displayMobileNav()
        },
        ...
        displayHeaderContainer: function () {
            animationOut(document.getElementsByClassName("content_header")[0], "effect_header", 1e3)
        },
        ...
        displayIcon: function () {
            animationOut(document.getElementsByClassName("icone")[0], "opacity_effect", 6e3)
        },
    ...
    sectionProjectsAnimation = {
        indicePics: 1,
        init: function () {
            sectionProjectsAnimation.formEffect(), sectionProjectsAnimation.displayTitleForm(), sectionProjectsAnimation.aboutMeEffect()
        },
        displayTitleForm: function () {
            var e = document.getElementsByClassName("container_form")[0].querySelector("h1");
            scroll(e, "fadeRightEffect", 2)
        },
        formEffect: function () {
            var e = document.getElementsByClassName("contact_me")[0].querySelector("form");
            scroll(e, "form_effect", 2)
        },
        aboutMeEffect: function () {
            var e = document.getElementsByClassName("div_one")[0],
                t = document.getElementsByClassName("div_two")[0];
            scroll(e, "fadeLeftEffect", 2), scroll(t, "fadeRightEffect", 2)
        },
        mainDiv: function () {
            var e = document.getElementsByClassName("main_div")[0];
            scroll(e, "opacity_on_two", 0)
        },
        ...
        presentationDeveloperJunior: function () {
            var e = document.getElementsByClassName("home_about_text");
            scroll(e[0], "home_dev_junior_pre", 1.3)
        },
