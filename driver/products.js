...
let targetElements = {
    ...
    imgs: document.getElementsByClassName("li_imgs")
}
targetElements.parentProduct.innerHTML = displayPageHtml();
let deleteArticleFromRelatedSection = targetElements.articleSelected.parentElement.removeChild(targetElements.articleSelected);
