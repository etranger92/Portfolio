...
let productsDetail = [{
        ...
        description: 'Mont St Michel is a place of sheer enchantment in the middle of the bay.Marvel of the western
        world,
        ...
        beautiful in France with its small typical villages,
        farms and cattle which are producing the famous
        Camembert,
        Livarot and Pont l’ Eveque cheeses.
        You will have plenty of time to visit the site,
        its monumental halls,
        the cloister,
        the state
...
let displayPage = indice => {
  ...
  src = ${productsDetail[indice].src[2]} > < /li> <
      ...
      div class = "product" >
      <
      h2 > ${productsDetail[indice].title} < /h2> <
