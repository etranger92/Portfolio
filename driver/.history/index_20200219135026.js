...
let eventFields = (() => {
    ...
    LOCATION_FIELDS.firstName.addEventListener("focus", deleteErrorMessageOnFocus);
...
`, `<article class="slider_article_2 ">
                <div class="slider_top_details">
                    <h2 class="appear_h3_slider">You will find it</h2>
                    <h3 class="appear_h2_slider"> Here</h3>
