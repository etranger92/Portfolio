...
let displayAnimationBody = {
    ...
    insertArticles() {
        ...
        let sliderImgSubMenu = () => {
            ...
            if (dots[displayAnimationBody.indice]) dots[displayAnimationBody.indice].style.backgroundColor = "white";
            else {
                dots = dots.map((item, index) => {
                    if (dots[displayAnimationBody.indice] != index) item.style.backgroundColor = "none"
                })
            }
        }
