...
console.log(productSelectedName)
let productsDetail = {
    ...
    paris: {
        src: ["./imgs/product pics/effeil.jpg", "./imgs/product pics/effeil1.jpg", "./imgs/effeil3.jpg"],
        title: "PARIS",
...
let displayPageHtml = (product = productSelectedName) => {
  ...
  <div class = "pics_product">
      <p> < img src=${productsDetail.product.src[0]} > < /img></p >
      <ul>
      <li> < img class = "li_imgs" src = ${productsDetail.product.src[1]} >
      </li> 
      <li> <img class = "li_imgs" src = ${productsDetail.product.src[2]}> 
  </li> </ul> </div> <div class = "product">
      <h2> ${productsDetail.product.title} < /h2> <
      span > Excursions < /span> <ul>
...
console.log(targetElements.parentProduct)
let insertProduct = () => targetElements.parentProduct.insertBefore(displayPageHtml(productSelectedName), targetElements.sibiling);
/*Animations*/
