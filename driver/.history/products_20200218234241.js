...
let productsDetail = {
    ...
    stmichael: {
        src: ["./imgs/product pics/architecture-bridge-building-city-220769.jpg", "./imgs/product pics/architecture-bridge-building-city-220769.jpg", "./imgs/MONT ST MICHEL.jpg"],
...
let displayPageHtml = (product = productSelectedName) => {
  ...
  <div class = "pics_product">
      ...
      <ul>
      <li> <img class = "li_imgs" src = "${productsDetail[product].src[0]}"> </li> 
      <li> <img class="li_imgs" src=${productsDetail[product].src[0]}></li> </ul> </div> <div class = "product">
